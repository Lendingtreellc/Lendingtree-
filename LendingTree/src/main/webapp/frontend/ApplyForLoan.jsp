            ...
            <div class="row">
				...
				<div class="form-group">
				    <input type="hidden" name="status" value="pending" required/>
                        ...
                        Loan Type: <br>
                        <td><input type="radio" name="loantype" value="home"/>Home Loan<br>
					    <input type="radio" name="loantype" value="personal" />Personal Loan<br>
					    <input type="radio" name="loantype" value="education"/>Education Loan<br>
					    <input type="radio" name="loantype" value="crop"/>Crop Loan<br>
